...
import { createItemBodySchema, updateItemBodySchema, searchItemsQuerySchema, listItemsQuerySchema, searchSuggestionsQuerySchema, updateItemVariantBodySchema, updateVariantAuctionItemBodySchema } from "../schemas/item.schemas";
...
export class ItemController {
    ...
    updateVariant = async (req: Request, res: Response) => {
        try {
            ...
            return Send.success(res, updatedVariant, "Item variant updated successfully.");
        } catch (error) {
    ...
    partialUpdate = async (req: Request, res: Response) => {
        try {
            ...
            const item = await this.itemService.updateItem(id, bodyValidation.data, userId);
    ...
    updateVariantAuctionItem = async (req: Request, res: Response) => {
        try {
            // 1. Validate request body
            const bodyValidation = updateVariantAuctionItemBodySchema.safeParse(req.body);
            if (!bodyValidation.success) {
                return Send.error(res, bodyValidation.error.issues, "Invalid request data.", 400);
            }
            ...
            return Send.success(res, updatedItem, "Auction item updated successfully.");
        } catch (error) {
    ...
    suggestions = async (req: Request, res: Response) => {
        try {
            ...
            const suggestions = await this.itemService.getSearchSuggestions(query, limit);

            return Send.success(res, { suggestions }, "Suggestions retrieved successfully.");
        } catch (error) {
